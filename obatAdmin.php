      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-body">
              <button type="button" class="btn btn-success btn-sm float-right" data-toggle="modal" data-target="#addModal">Tambah Obat</button>
               <br><br> 
                    ...
                    foreach ($obatData as $obatRow) {
                      ...
                      echo "<td>
                                                <form method='post' action=''>
                                                    ...
                                                    data-harga='" . $obatRow['harga'] . "'>Edit</button>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="updateModalLabel">Edit Obat</h5>
        ...
        <div class="modal-body">
          <form method="post" action="menuAdmin.php">
            ...
            <button type="submit" name="update_obat_modal" class="btn btn-primary">Edit</button>
          </form>
        </div>
      </div>
    </div>
